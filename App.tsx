      ...
      <main className="flex-1">
        ...
        {currentStep === Step.Home && (
          <>
              ...
              <div className="relative z-10 flex flex-col items-center justify-center min-h-[600px] px-6 py-20 text-center">
                <div className="max-w-[800px] flex flex-col items-center gap-8">
                  ...
                  <div className="flex flex-col sm:flex-row items-center gap-4 mt-4">
                    <button 
                      onClick={startFlow}
                      className="flex items-center justify-center gap-3 bg-earthy-brown text-white h-14 px-8 rounded-lg text-base font-bold hover:bg-[#724b2f] transition-all shadow-lg hover:shadow-xl transform hover:-translate-y-0.5"
                    >
            ...
            {/* Transparency Section - UPDATED (No Geo-tags) */}
            <section className="w-full bg-white py-20 px-6">
              <div className="max-w-[1280px] mx-auto">
                  ...
                  <div className="flex flex-col lg:flex-row">
                    ...
                    <div className="lg:w-1/2 p-10 lg:p-16 flex flex-col justify-center">
                      ...
                      <h2 className="text-white text-3xl md:text-4xl font-black leading-tight mb-6">
                        Transparent &amp; Sustainable Impact
                      </h2>
                      
                      <p className="text-gray-300 text-lg leading-relaxed mb-8">
                        We believe in the power of community. Every sapling planted is a step towards a greener future, ensuring a verified, lasting legacy for generations to come.
                      </p>
                      ...
                      <div className="flex flex-col sm:flex-row gap-6">
                        <div className="flex items-start gap-3">
                          ...
                          <div>
                            <h4 className="text-white font-bold text-lg">Community Led</h4>
                            <p className="text-gray-400 text-sm mt-1">Driven by people, for the planet.</p>
                          </div>
                        </div>
                        ...
                        <div className="flex items-start gap-3">
                          <span className="material-symbols-outlined text-primary mt-1">check_circle</span>
                          <div>
                            <h4 className="text-white font-bold text-lg">Sustainable Growth</h4>
                            <p className="text-gray-400 text-sm mt-1">Ensuring long-term survival and care.</p>
                          </div>
                        </div>
                      </div>
                    </div>
        ...
        <footer className="w-full bg-[#0a160c] text-white pt-16 pb-8 border-t border-[#1a2f1e] mt-auto">
          <div className="max-w-[1280px] mx-auto px-6">
              ...
              <div className="flex flex-col gap-6">
                ...
                <div className="flex flex-col gap-4">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <a className="text-sm font-medium text-gray-300 hover:text-white transition-colors" href="mailto:hafizrk@communitree.co.in">hafizrk@communitree.co.in</a>
                  </div>
                </div>
              </div>
            ...
            <div className="pt-8 border-t border-[#1a2f1e] flex flex-col md:flex-row justify-between items-center text-xs text-gray-500 gap-4">
              <p>© 2026 Communitree. All rights reserved.</p>
...
// Wrap App with Provider (Correcting previous omission)
